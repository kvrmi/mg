...
const MINES_COEFFICIENTS = [
  [
    ...
    2.17, 2.39, 2.65, 2.98, 3.41, 3.98, 4.78, 5.97, 7.96, 11.94, 23.88, 47.76,
  ],
  [
    1.09, 1.24, 1.43, 1.65, 1.93, 2.27, 2.69, 3.23, 3.92, 4.83, 6.03, 7.68,
    9.98, 13.31, 18.3, 26.15, 39.22, 62.76, 109.83, 219.65, 549.13, 2196.5, 8786, 
  ],
  [
    1.19, 1.51, 1.93, 2.49, 3.27, 4.36, 5.92, 8.2, 11.62, 16.9, 25.34, 39.42,
    64.06, 109.83, 201.35, 402.69, 906.06, 1937.37, 2968.69, 4000, 10000,
  ],
  [
    1.32, 1.86, 2.68, 3.93, 5.89, 9.11, 14.43, 23.6, 40.13, 71.34, 133.76,
    267.52, 579.63, 1463.71, 2347.78, 3231.85, 4115.93, 5000, 20000,
  ],
];
  ...
  setTimeout(() => {
    ...
    $('.Toastify__toast-container').html(
      `<div class="Toastify--animate Toastify__bounce-enter--top-center Toastify__toast Toastify__toast--close-on-click Toastify__toast--default Toastify__toast-theme--dark app-popup__toast win"><div class="Toastify__toast-body app-popup__toast-body"role=alert><div><div class=app-popup__toast-body__win><div class=left-side><div class=left-side__label>Ваш выигрыш</div><p class=left-side__lightgreen><span id=winValuePopup>${winAmount.toLocaleString(
        'ru-RU'
      )}</span> <span id=winCurrencyPopup class=left-side__small-gray>₽</span></div><div class=right-side id=winCoefPopup>x${winCoefficient}</div></div></div></div></div>`
    );
